...
export const getPogAuto = () => httpApi.get<IPogAuto[]>(`${BASE_URL}/get/all/pogSubjAuto`).then(({ data }) => data);

export const createPogSubjAuto = (data: IPogAuto) =>
  httpApi.post<IPogAuto>(`${BASE_URL}/create/pogSubjAuto`, data).then(({ data }) => data);

export const updatePogSubjAuto = (data: IPogAuto) =>
  httpApi.post<IPogAuto>(`${BASE_URL}/update/pogSubjAuto`, data).then(({ data }) => data);
