...
export const blockUser = (user: DeleteUserDTO) =>
    httpApi.put('users/block', { ...user }).then(({ data }) => data);

export const unblockUser = (user: DeleteUserDTO) =>
    httpApi.put('users/unblock', { ...user }).then(({ data }) => data);
